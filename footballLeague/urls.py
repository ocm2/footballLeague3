...
from prac3.views import *
from prac3.models import *
...
urlpatterns = patterns('',
	...
	url(r'^league/(?P<pk>\d+)/$', LeagueModel.as_view(model = League), name ='League Details'),
...
#EDIT
	...
	url(r'league/(?P<pk>\d+)/league_edit/$' ,Edit.as_view(model = League, form_class = LeagueForm, 	template_name = 'forms.html'), name='League Edit'),
